...
Revision ID: 52f0b80bd5f7
Revises: 
Create Date: 2024-11-19 05:38:40.639435
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['face_embed_id'], ['person_face_embedding.id'], name='person-faceEmbed-fk', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
