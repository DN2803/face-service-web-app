...
Revision ID: f13cdec78f35
Revises: 
Create Date: 2024-11-25 13:15:06.769723
...
def upgrade():
    ...
    sa.Column('img_name', sa.String(length=36), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['collection_id'], ['collection.id'], name='person-collection-fk', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['person_id'], ['person.id'], name='embed-person-fk'),
    sa.PrimaryKeyConstraint('id')
    )
